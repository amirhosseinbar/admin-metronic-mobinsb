...
export const handleNotificationAlertTryUpdate = (responseData, actionSelect, dispatch, argomentAction) => {

  if (responseData.status === 403 && responseData.error === "PERMISSION DENIED") {
      dispatch({ type: "ALERT", payload: { status: true, textAlert: `شما دسترسی به انجام این عملیات را ندارید.`, typeAlert: "warning" } })
  }
...
export const handleNotificationAlertTrySelect = (responseData, dispatch) => {
